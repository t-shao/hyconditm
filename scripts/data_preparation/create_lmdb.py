...
def create_lmdb_for_tmp():
    folder_path = 'datasets/HDRTV1K/train/train_sdr_sub'
    lmdb_path = 'datasets/HDRTV1K/train/train_sdr_sub.lmdb'
    img_path_list, keys = prepare_keys_div2k(folder_path)
    make_lmdb_from_imgs(folder_path, lmdb_path, img_path_list, keys)


def create_lmdb_for_hdrtv1k():
    # HDR images
    folder_path = 'datasets/HDRTV1K/train/train_hdr_sub'
    lmdb_path = 'datasets/HDRTV1K/train/train_hdr_sub.lmdb'
    img_path_list, keys = prepare_keys_div2k(folder_path)
    make_lmdb_from_imgs(folder_path, lmdb_path, img_path_list, keys)
...
def create_lmdb_for_div2k():
    ...
    Usage:
        Before run this script, please run `extract_subimages_div2k.py`.
...
if __name__ == '__main__':
    ...
    elif dataset == 'hdrtv1k':
        create_lmdb_for_hdrtv1k()
    elif dataset == 'tmp':
        create_lmdb_for_tmp()
    else:
